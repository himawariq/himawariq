...
Меня зовут **Соколов Александр**, работаю аналитиком данных в банке(ml /dl / поднимаю бд в datagrip / визуализация дешбордов в superset / увлекаюсь StyleGan3). Здесь немного информации обо мне:
